...
#include "VirtualLab/Grabber.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeGrabber() {}
// Cross Module References
	VIRTUALLAB_API UClass* Z_Construct_UClass_UGrabber_NoRegister();
	VIRTUALLAB_API UClass* Z_Construct_UClass_UGrabber();
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGrabber_Statics::NewProp_FixedRotation_MetaData[] = {
		{ "Category", "Grabber" },
		{ "ModuleRelativePath", "Grabber.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGrabber_Statics::NewProp_FixedRotation = { "FixedRotation", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGrabber, FixedRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_UGrabber_Statics::NewProp_FixedRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGrabber_Statics::NewProp_FixedRotation_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGrabber_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGrabber_Statics::NewProp_FixedRotation,
	};
	...
	template<> VIRTUALLAB_API UClass* StaticClass<UGrabber>()
	{
		return UGrabber::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UGrabber);
	struct Z_CompiledInDeferFile_FID_VirtualLab_Source_VirtualLab_Grabber_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VirtualLab_Source_VirtualLab_Grabber_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGrabber, UGrabber::StaticClass, TEXT("UGrabber"), &Z_Registration_Info_UClass_UGrabber, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGrabber), 3136186150U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VirtualLab_Source_VirtualLab_Grabber_h_1348171983(TEXT("/Script/VirtualLab"),
		Z_CompiledInDeferFile_FID_VirtualLab_Source_VirtualLab_Grabber_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VirtualLab_Source_VirtualLab_Grabber_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
